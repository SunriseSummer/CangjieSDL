...
![仓库雷霆战机示例的真实运行效果](../../../../../sdl/examples/thunder/screenshot.png)

上图尺寸为 800×600，SHA-256 为 `61f2894c60149e1d90012d1566b9df7702b680c6f38fc7a79e714ae6b149c127`。它显示了分层背景、玩家、连续子弹、HUD 与实体集合；本页的完整程序先把时间和输入骨架做对，再引导你进入这些真实层次。
